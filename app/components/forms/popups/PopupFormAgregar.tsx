  ...
  return (
    <PopupContainer onClose={onClose} title={title}>
      <div className="relative h-full flex flex-col pt-4 space-y-6">
        {description && (
          <div className="bg-emerald-400/10 border-l-4 border-emerald-400 p-4 rounded-r-md">
        ...
        <div className="absolute bottom-4 right-4 flex justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
            className="cursor-pointer px-5 py-2.5 admin-button-ghost rounded-lg transition-all duration-200 font-medium shadow-sm"
          >
            Cancelar
          </button>
          <button
